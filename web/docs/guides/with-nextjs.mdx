...
<Editor
  ...
  initialCode={snippets.supabaseClient}
/>
...
<Editor
  ...
  initialCode={snippets.componentsAuth}
/>
...
<Editor
  ...
  initialCode={snippets.componentsAccount}
/>
...
<Editor
  ...
  initialCode={snippets.pagesIndex}
/>
...
<Editor
  ...
  initialCode="npm run dev"
/>
<Output
  stdout={['> dev', '> next dev', 'ready - started server on 0.0.0.0:3000, url: http://localhost:3000', 'info  - Loaded env from /Users/vasekmlejnsky/Developer/supabase-nextjs/.env', 'event - compiled client and server successfully in 464 ms (125 modules)']}
/>

And then open the browser to [localhost:3000](http://localhost:3000) and you should see the completed app.

<Iframe
  url="https://3000-default_9c03f124-1589abde1b94.o.usedevbook.com"
  height={350}
/>

When you try to login a new row in the Database is added. Run the following SQL query to print all of registered users.
<Editor
  sql={snippets.sqlProfiles}
/>
